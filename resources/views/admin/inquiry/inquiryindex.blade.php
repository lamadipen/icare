                            ...
                            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                ...
                                <div class="row"><div class="col-sm-12">
                                        <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                                            <thead>
                                            <tr role="row">
                                                <th class="sorting_asc" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 177px;" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">ProductID</th>
                                                ...
                                                <th class="sorting_asc" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 177px;" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Email</th>
                                            ...
                                            @foreach($inquiries as $inquiry)
                                                <tr class="gradeA odd" role="row">
                                                    <td class="sorting_1">{{ $inquiry['productid'] }}</td>
                                                    <td class="sorting_1">{{ $inquiry['name'] }}</td>
                                                    <td class="sorting_1">{{ $inquiry['email'] }}</td>
                                                    <td>
                                                        <a id="" class="btn btn-default navbar-btn" href="{{ url('/admin/inquiry/'.$inquiry['id']) }}">show</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
